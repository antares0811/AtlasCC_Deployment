...
from nnUNet22.nnunetv2.training.nnUNetTrainer.STUNetTrainer import STUNetTrainer
...
class nnUNetPredictor(object):
    ...
    def initialize_from_trained_model_folder(self, model_training_output_dir: str,
        ...
        print(f'nnunetv2.__path__[0]: {nnunetv2.__path__[0]}')
        num_input_channels = determine_num_input_channels(plans_manager, configuration_manager, dataset_json)
        from nnUNet22.nnunetv2.training.nnUNetTrainer.STUNetTrainer import STUNetTrainer_large_ft, STUNetTrainer_base_ft
        nnunet22_path = "./nnUNet22/nnunetv2"
        trainer_class = recursive_find_python_class(join(nnunet22_path, "training", "nnUNetTrainer"),
                                                    trainer_name, 'nnUNet22.nnunetv2.training.nnUNetTrainer')
        # trainer_class = recursive_find_python_class(join(nnunetv2.__path__[0], "training", "nnUNetTrainer"),
        #                                             trainer_name, 'nnunetv2.training.nnUNetTrainer')
        print(f'trainer class: {trainer_class}')
        # trainer_class = STUNetTrainer_large_ft
        trainer_class = STUNetTrainer_base_ft
